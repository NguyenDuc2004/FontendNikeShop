...
const ShoppingCart = () => {
    ...
    const handleRemoveCart = async (productId) => {
        const suffixUrl = "/client/carts/remove"; // Đường dẫn API
        try {
                                ...
                                <div className="p-6 mt-4 bg-[#f6f6f6] rounded-lg">
...

                                    {
                                        isLogin ? (
                                            ...
                                            <Link to={"/login"} className="flex items-center justify-center h-[50px] mt-6 bg-black w-full text-white font-semibold text-sm px-4 flex-1 rounded-full hover:bg hover:bg-white border hover:border-black hover:text-black transition-all">
                                                Thanh toán
                                            </Link>
                                        )
                                    }
